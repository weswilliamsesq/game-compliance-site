      ...
      <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: "32px" }}>
        ...
        <div style={{ border: `3px solid ${C.cyan}`, background: C.surface, padding: "28px",
          ...
          {[
            ...
            `After years of mastering title insurance and real estate transactions, Wes leveled up by joining one of the world's leading video game payment platforms as Corporate Counsel.`,
        ...
        <div style={{ padding: "32px 28px", display: "grid",
          ...
          <div>
            ...
            <p style={{ fontFamily: "'Courier New', monospace", fontSize: "12px",
              ...
              Four years as in-house counsel at a major gaming payments platform — one of the world's leading video game payment platforms. Full-stack gaming law: virtual currency, loot boxes, developer agreements, COPPA/GDPR, and GameCompliance™.
            </p>
          </div>
          <div>
