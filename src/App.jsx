      ...
      <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: "32px" }}>
        ...
        <div style={{ border: `3px solid ${C.cyan}`, background: C.surface, padding: "28px",
          ...
          {[
            ...
            `After years of mastering title insurance and real estate transactions, Wes leveled up by joining one of the world's leading video game payment platforms as a one-man legal department for four years. Commercial contracts, M&A, international regulatory compliance, blockchain integrations — all in the final boss dungeon of gaming fintech.`,
